...
<!-- Mirrored from cdn1.crumina.net/html-CLOUD ECOD/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Jan 2017 13:50:37 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head lang="en">
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <title>CLOUD ECOD - Index Page</title>

    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/fonts.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/crumina-fonts.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/normalize.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/grid.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/base.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/blocks.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/layouts.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/modules.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/widgets-styles.css">


    <!--Plugins styles-->

    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/jquery.mCustomScrollbar.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/swiper.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>Assets/home/css/primary-menu.css">
...
<header class="header" id="site-header" style="background-color:#f7f9f9;">

    <div class="container">

            <div class="header-content-wrapper">

                <div class="logo" style="max-width:25%;">
                    <a href="index-2.html" class="full-block-link"></a>
                   <!--  <img src="<?php echo base_url();?>Assets/home/img/lightlogo2.png" alt="CLOUD ECOD" style="Width:100%; margin-bottom:5%; "> -->
                    <div class="logo-text">
                        <div class="logo-title" style="letter-spacing:7px;">MEA ECOD</div>
                        <div class="logo-sub-title">Just Dream!</div>
                    </div>
                </div>
                ...
                <nav id="primary-menu" class="primary-menu" >
                    ...
                    <ul class="primary-menu-menu">
                        ...
                        <li class="">
                            <a href="03_services.html">Location</a>
                            <ul class="dropdown">
                                <li class="megamenu-item-info">
                                    <h5 class="megamenu-item-info-title">Location</h5>
                                    <p class="megamenu-item-info-text">Choose a where you located to get the best serivce</p>
                                </li>
                                <li class="hover-ver2">
                                    <a href="http://bmxdubai.mybluemix.net/"><i class="seoicon-pin-map"></i>
                                        UAE
                                    </a>
                                </li>
                                <li class="hover-ver2">
                        ...
                        <li class="">
                            <a href="#" onclick="cs();">Case Studies</a>
                           <!--  <ul class="dropdown">
                                <li class="">
                        ...
                        <!-- <li class="has-megamenu menu-item-has-children">
                            ...
                            <div class="megamenu" style="background-image: url('<?php echo base_url();?>Assets/home/img/menu-bg.png');">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="google-logo">
                                                    <img src="<?php echo base_url();?>Assets/home/img/google-logo.png" alt="logo">
                                                </div>
                ...
                <ul class="nav-add" style="margin-top:1.8%;">
                   <!--  <li class="cart">
    ...
    <div class="popup right-menu">
        ...
        <div class="right-menu-wrap">
            ...
            <div class="logo">
                ...
                <div class="logo-text">
                    <div class="logo-title">CLOUD ECOD</div>
                </div>
            </div>

            <p class="text">ECOD Members Login
            </p>
        ...
        <div class="widget contacts">
            ...
            <div class="contacts-item">
                <img src="<?php echo base_url();?>Assets/home/img/contact4.png" alt="phone">
                <div class="content">
                     <a href="#" class="title">1234567890</a>
                            <p class="sub-title">Mon-Fri 9am-6pm</p>
                </div>
            </div>

            <div class="contacts-item">
                <img src="<?php echo base_url();?>Assets/home/img/contact5.png" alt="phone">
                <div class="content">
                   <a href="#" class="title">fafawzy@eg.ibm.com</a>
                            <p class="sub-title">online support</p>
                </div>
            </div>

            <div class="contacts-item">
                <img src="<?php echo base_url();?>Assets/home/img/contact6.png" alt="phone">
                <div class="content">
                     <a href="#" class="title">Cairo, Egypt</a>
                            <p class="sub-title">IBM Office in Pyramids Heights</p>
                </div>
            </div>
                            ...
                            <div class="row table-cell">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="slider-content align-center">
                                        ...
                                        <h1 class="slider-content-title" data-swiper-parallax="-100">IBM Cloud Ecosystem Developers</h1>
                                        <h5 class="slider-content-text c-gray" data-swiper-parallax="-200">WE CAN MAKE YOUR DREAMS COME TRUE!</br>ALL YOU NEED TO DO IS TELLING US!</h5>
                                ...
                                <div class="col-lg-12">
                                    <div class="slider-thumb" data-swiper-parallax="-400" data-swiper-parallax-duration="600">
                                        <img src="<?php echo base_url();?>Assets/home/img/slider1.png" alt="slider">
                                    </div>
                                </div>
                            ...
                            <div class="row table-cell">
                                ...
                                <div class="col-lg-5 table-cell">
                                    <div class="slider-content">
                                        <h3 class="slider-content-title" data-swiper-parallax="-100"><span class="c-dark">Technical Enablement &amp; Support</span>
                                            is about helping everybody understand &amp; use IBM Technology</h3>
                                ...
                                <div class="col-lg-7 table-cell">
                                    <div class="slider-thumb" data-swiper-parallax="-300" data-swiper-parallax-duration="500">
                                        <img src="<?php echo base_url();?>Assets/home/img/slider2.png" alt="slider">
                                    </div>
                                </div>
                            ...
                            <div class="row table-cell">
                                <div class="col-lg-6 table-cell">
                                    ...
                                    <div class="slider-content">
                                        ...
                                        <h3 class="h1 slider-content-title c-dark" data-swiper-parallax="-100">ECOSYSTEM DEVELOPMENT
                                        </h3>

                                        <h5 class="slider-content-text" data-swiper-parallax="-200">A Call for Startups and Developers in the MEA Region.
                                ...
                                <div class="col-lg-6 table-cell">
                                    <div class="slider-thumb" data-swiper-parallax="-300" data-swiper-parallax-duration="500">
                                        <img src="<?php echo base_url();?>Assets/home/img/slider3.png" alt="slider">
                                    </div>
                                </div>
                        ...
                        <div class="container table full-height">
                            <div class="row table-cell">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="slider-content align-center">
                                        <h3 class="h1 slider-content-title c-dark" data-swiper-parallax="-100">Creative
                                            Marketing</h3>
                                        <h5 class="slider-content-text" data-swiper-parallax="-200">We use the latest technologies and demos
                                            to create tailored marketing
                                            campaigns to help advertise products and services in efforts to efficiently
                                ...
                                <div class="col-lg-12">
                                    <div class="slider-thumb" data-swiper-parallax="-400" data-swiper-parallax-duration="600">
                                        <img src="<?php echo base_url();?>Assets/home/img/slider4.png" alt="slider">
                                    </div>
                            ...
                            <div class="row table-cell">
                                ...
                                <div class="col-lg-6 table-cell">
                                    <div class="slider-content">
                                        ...
                                        <h3 class="h1 slider-content-title c-dark" data-swiper-parallax="-100">Event
                                            Management &amp; Sponsorships
                                        </h3>

                                        <h5 class="slider-content-text" data-swiper-parallax="-200">IBM sponsor your event if it fits its plan and we assure you the best speakers to talk in your event
                                        </h5>
...
<!-- 
                                ...
                                <div class="col-lg-6 table-cell">
                                    <div class="slider-thumb" data-swiper-parallax="-300" data-swiper-parallax-duration="500">
                                        <img src="<?php echo base_url();?>Assets/home/img/slider5.png" alt="slider">
                                    </div>
                                </div>
                ...
                <div class="slider-slides">
                    <a href="#" class="slides-item bg-border-color main-slider-bg-light">
                        <div class="content">
                            <div class="text-wrap">
                                <h4 class="slides-title">MEA ECOD</h4>
                            </div>
                    ...
                    <a href="#" class="slides-item bg-primary-color">
                        <div class="content">
                            <div class="text-wrap">
                                <h4 class="slides-title">Technical Enablement &amp; Support</h4>
                    ...
                    <a href="#" class="slides-item bg-secondary-color">
                        <div class="content">
                            <div class="text-wrap">
                                <h4 class="slides-title">Ecosystem Development</h4>
                            </div>
                    ...
                    <a href="#" class="slides-item bg-orange-color">
                        <div class="content">
                            <div class="text-wrap">
                                <h4 class="slides-title">Creative Marketing</h4>
                            </div>
                    ...
                    <a href="#" class="slides-item bg-green-color">
                        <div class="content">
                            <div class="text-wrap">
                                <h4 class="slides-title">Event Management &amp; Sponsorships</h4>
                            </div>
...
<!-- <div class="container info-boxes pt100 pb100">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box--standard" data-mh="info-boxes">
                <div class="info-box-image">
                    <img src="<?php echo base_url();?>Assets/home/img/info-box1.png" alt="image">
                </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box--standard" data-mh="info-boxes">
                <div class="info-box-image">
                    <img src="<?php echo base_url();?>Assets/home/img/info-box2.png" alt="image">
                </div>
                <div class="info-box-content">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box--standard" data-mh="info-boxes">
                <div class="info-box-image">
                    <img src="<?php echo base_url();?>Assets/home/img/info-box3.png" alt="image">
                </div>
                <div class="info-box-content">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box--standard" data-mh="info-boxes">
                <div class="info-box-image">
                    <img src="<?php echo base_url();?>Assets/home/img/info-box4.png" alt="image">
                </div>
                <div class="info-box-content">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box--standard" data-mh="info-boxes">
                <div class="info-box-image">
                    <img src="<?php echo base_url();?>Assets/home/img/info-box5.png" alt="image">
                </div>
                <div class="info-box-content">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            <div class="info-box--standard" data-mh="info-boxes">
                <div class="info-box-image">
                    <img src="<?php echo base_url();?>Assets/home/img/info-box6.png" alt="image">
                </div>
                <div class="info-box-content">
            ...
            <div class="offers">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="heading">
                            <p class="heading-text">We can always help you, just ask!
                            </p>
                        </div>
                        ...
                        <ul class="list list--secondary">
                            ...
                            <li>
                                <i class="seoicon-check"></i>
                                <a href="#">Fast POCs and technical demos</a>
                            </li>
                            <li>
                                <i class="seoicon-check"></i>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                        <div class="offers-thumb">
                            <img style="margin-top:-25%; width:90%;" src="<?php echo base_url();?>Assets/home/img/avatar 3.png" alt="offers">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 no-padding">
                <div class="video theme-module">
                    <div class="video-thumb">
                        ...
                        <a href="https://www.youtube.com/watch?v=Bu3T3NzSLAQ" class="video-control js-popup-iframe">
                            <img src="<?php echo base_url();?>Assets/home/svg/video-control.svg" alt="go">
                        </a>
                    </div>
                </div>
            </div>
...
<!-- <div class="container-fluid">
    <div class="row">
        <div class="background-mountains medium-padding120 scrollme">
            ...
            <div class="images">
                <img src="<?php echo base_url();?>Assets/home/img/mountain1.png" alt="mountain">
                <img src="<?php echo base_url();?>Assets/home/img/mountain2.png" alt="mountain">
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="info-box--standard-centered">
                            <div class="info-box-image">
                                <img src="<?php echo base_url();?>Assets/home/img/info-box7.png" alt="image">
                            </div>
                            <div class="info-box-content">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="info-box--standard-centered">
                            <div class="info-box-image">
                                <img src="<?php echo base_url();?>Assets/home/img/info-box8.png" alt="image">
                            </div>
                            <div class="info-box-content">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="info-box--standard-centered">
                            <div class="info-box-image">
                                <img src="<?php echo base_url();?>Assets/home/img/info-box9.png" alt="image">
                            </div>
                            <div class="info-box-content">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="info-box--standard-centered">
                            <div class="info-box-image">
                                <img src="<?php echo base_url();?>Assets/home/img/info-box10.png" alt="image">
                            </div>
                            <div class="info-box-content">
                ...
                <div class="row">
                    <div class="case-item-wrap">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="case-item">
                                <div class="case-item__thumb">
                                    <img src="<?php echo base_url();?>Assets/home/img/case1.jpg" alt="our case">
                                </div>
                        ...
                        <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                            <div class="case-item">
                                <div class="case-item__thumb">
                                    <img src="<?php echo base_url();?>Assets/home/img/case2.jpg" alt="our case">
                                </div>
                        ...
                        <div class="col-lg-4  col-md-4 col-sm-6 col-xs-12">
                            <div class="case-item">
                                <div class="case-item__thumb mouseover poster-3d lightbox shadow animation-disabled" data-offset="5">
                                    <img src="<?php echo base_url();?>Assets/home/img/case3.jpg" alt="our case">
                                </div>
    ...
    <div class="row">
        <div class="testimonial-slider scrollme">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="heading">
                            ...
                            <p class="heading-text c-white">We always aim to please!
                            </p>
                        </div>
                    ...
                    <div class="col-lg-7 col-lg-offset-1 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="testimonial-item">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="testimonial-slider-item swiper-slide">
                                        <div class="testimonial-content">
                                            <p class="text" data-swiper-parallax="-200">Great Bluemix Support and fast delievery of a conversational Bot POC!
                                                Thanks IBM
                                            </p>
                                            <a href="#" class="author" data-swiper-parallax="-150">ENG. Hatem</a>
                                            <a href="#" class="company" data-swiper-parallax="-150">MED4D</a>

                                        </div>
                                        <div class="avatar" data-swiper-parallax="-50">
                                            <img src="<?php echo base_url();?>Assets/home/img/avatar.png" alt="avatar">
                                        </div>
                                    </div>
                                    <!-- <div class="testimonial-slider-item swiper-slide">
                                        <div class="testimonial-content">
                            ...
                            <div class="testimonial__thumb-img">
                                <img src="<?php echo base_url();?>Assets/home/img/testimonial1.png" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="testimonial-img">
                <img src="<?php echo base_url();?>Assets/home/img/testimonial2.png" alt="image">
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="pricing-tables-wrap">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="pricing-tables-item">
                                <div class="pricing-tables-icon">
                                    <img src="<?php echo base_url();?>Assets/home/img/pricing1.png" alt="personal">
                                </div>
                                ...
                                <img src="<?php echo base_url();?>Assets/home/img/pricing-dots.png" class="dots" alt="dots">
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="pricing-tables-item">
                                <div class="pricing-tables-icon">
                                    <img src="<?php echo base_url();?>Assets/home/img/pricing2.png" alt="personal">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="pricing-tables-item">
                                <div class="pricing-tables-icon">
                                    <img src="<?php echo base_url();?>Assets/home/img/pricing3.png" alt="personal">
                                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide client-item">
                            <a href="09_our_clients.html" class="client-image">
                                <img src="<?php echo base_url();?>Assets/home/img/client1-hover.png" alt="logo" class="hover">
                            </a>
                        </div>

                        <div class="swiper-slide client-item">
                            <a href="09_our_clients.html" class="client-image">
                                <img src="<?php echo base_url();?>Assets/home/img/client2-hover.png" alt="logo" class="hover">
                            </a>
                        </div>

                        <div class="swiper-slide client-item">
                            <a href="09_our_clients.html" class="client-image">
                                <img src="<?php echo base_url();?>Assets/home/img/client3-hover.png" alt="logo" class="hover">
                            </a>
                        </div>

                        <div class="swiper-slide client-item">
                            <a href="09_our_clients.html" class="client-image">
                                <img src="<?php echo base_url();?>Assets/home/img/client4-hover.png" alt="logo" class="hover">
                            </a>
                        </div>
            ...
            <div class="row">
                ...
                <div class="subscribe scrollme">
                    ...
                    <div class="col-lg-6 col-lg-offset-5 col-md-6 col-md-offset-5 col-sm-12 col-xs-12">
                        ...
                        <form class="subscribe-form" method="post" action="http://cdn1.crumina.net/html-CLOUD ECOD/import.php">
                    ...
                    <div class="images-block">
                        <img src="<?php echo base_url();?>Assets/home/img/subscr-gear.png" alt="gear" class="gear">
                        <img src="<?php echo base_url();?>Assets/home/img/subscr1.png" alt="mail" class="mail">
                        <img src="<?php echo base_url();?>Assets/home/img/subscr-mailopen.png" alt="mail" class="mail-2">
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid" id="Contact">
    <div class="row">
        ...
        <div class="seo-score scrollme">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-xs-12 col-sm-12">
                        <div class="seo-score-content align-center">
                            ...
                            <div class="heading align-center">
                                <h4 class="h1 heading-title">Need Help?</h4>
                                <p class="heading-text">let us know when can we call you!</p>
                            </div>
            ...
            <div class="images">
                <img src="<?php echo base_url();?>Assets/home/img/seoscore1.png" alt="image">
                <img src="<?php echo base_url();?>Assets/home/img/seoscore2.png" alt="image">
                <img src="<?php echo base_url();?>Assets/home/img/seoscore3.png" alt="image">
            </div>
        ...
        <div class="row">
            ...
            <div class="info">
                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                    <div class="heading">
                        <h3 class="heading-title">IBM CLOUD ECOD</h3>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                            <p>
                    ...
                    <div class="socials">
                        <a href="#" class="social__item">
                            <img src="<?php echo base_url();?>Assets/home/svg/circle-facebook.svg" alt="facebook">
                        </a>
                        <a href="#" class="social__item">
                            <img src="<?php echo base_url();?>Assets/home/svg/twitter.svg" alt="twitter">
                        </a>
                        <a href="#" class="social__item">
                            <img src="<?php echo base_url();?>Assets/home/svg/google.svg" alt="google">
                        </a>
                        <a href="#" class="social__item">
                            <img src="<?php echo base_url();?>Assets/home/svg/youtube.svg" alt="youtube">
                        </a>
                        <a href="#" class="social__item">
                            <img src="<?php echo base_url();?>Assets/home/svg/rss.svg" alt="rss">
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <span>
                        Copyright © 2016 <a href="index-2.html" class="sub-footer__link"></a>
                        Developed by <a href="https://facebook.com/fo2shy">FFawzy</a>
                    </span>
...
<script src="<?php echo base_url();?>Assets/home/js/jquery-2.1.4.min.js"></script>
<script src="<?php echo base_url();?>Assets/home/js/crum-mega-menu.js"></script>
<script src="<?php echo base_url();?>Assets/home/js/swiper.jquery.min.js"></script>
<script src="<?php echo base_url();?>Assets/home/js/theme-plugins.js"></script>
<script src="<?php echo base_url();?>Assets/home/js/main.js"></script>
<script src="<?php echo base_url();?>Assets/home/js/form-actions.js"></script>

<script src="<?php echo base_url();?>Assets/home/js/velocity.min.js"></script>
<script src="<?php echo base_url();?>Assets/home/js/ScrollMagic.min.js"></script>
<script src="<?php echo base_url();?>Assets/home/js/animation.velocity.min.js"></script>
...
<!-- Mirrored from cdn1.crumina.net/html-CLOUD ECOD/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Jan 2017 13:51:40 GMT -->
</html>
